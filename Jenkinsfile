            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user9') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user9/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user9') {
                    ...
                    openshift.tag("user9/gateway-canary:latest", "user9/gateway:latest")
